        ...
        <div class="ss-nav-outbox">
            <ul class="ss-nav-box">
                <?php if(is_array($cate_list)): foreach($cate_list as $key=>$v): ?><li class="ss-nav-li">
                        <a href="<?php echo U('User/Posts/list',array('cate_id'=>$v['cate_id']));?>" class="ss-nav-a <?php if($v['cate_id'] == $_GET['cate_id']): ?>ss-nav-choose"<?php endif; ?>">
                            <?php echo ($v['name']); ?>
                        </a>
