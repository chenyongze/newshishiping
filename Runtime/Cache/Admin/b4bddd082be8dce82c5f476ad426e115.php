...
<ul id="myTab" class="nav nav-tabs" style="margin-top: 15px;">
    ...
    <li class="active" >
         <a href="<?php echo U('Admin/Comment/edit',array('post_id'=>I('get.post_id'),'cid'=>I('get.cid')));?>">评论修改</a>
    </li>
</ul>
...
<form action="" method="post" enctype="multipart/form-data" class="form-inline post-submit" enctype="multipart/form-data">
    <table class="table table-bordered table-condensed">
        <tr>
            ...
            <td rowspan="2"> 
                <input type="text" class="form-control" style="margin-bottom: 5px;" name="click_number" placeholder="请输入点赞数量" value="<?php echo ($old_data['click_number']); ?>">
                <textarea name="content" cols="70" rows="18" class="form-control" placeholder="请输入评论内容"><?php echo ($old_data['content']); ?></textarea>
            </td>
            <th>当前用户</th>
            <td>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="submit" class="btn btn-success bnt-sm" value="修改">
            </td>
        </tr>
    </table>   
</form>
